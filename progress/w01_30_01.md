...
|----------	|-------	|--------	|
| Choose a project | *Chosen* | [Link](https://github.com/italanta/portfolio) |
| Run the project | Project is *running* | |
| Pick a teammate | Teammate *picked* | [*Link*](https://github.com/Danstan-O) |
...
| Choose an issue | Issue *chosen*  | https://github.com/italanta/elewa-group/issues/1 |
...
- My mood this week was (exciting) because of getting my hands dirty on a new programming language
  
- Compared to last week, I feel more (grateful) because of getting onboard to the iTalanta programme
